...
const users = [{
  id: 0, role: roles[4], fullName: 'Bohuslav Růžička',
}, {
  id: 1,
  role: roles[3],
  ...
  id: 4, role: roles[2], fullName: 'Josef Novák', students: [{
    "firstname": "Hermína",
    "surname": "Bukovská",
  ...
  id: 5, role: roles[2], fullName: 'František Svoboda', students: [{
    "firstname": "Naděžda",
    "surname": "Skalická",
  ...
  id: 6, role: roles[2], fullName: 'Ivan Novotný', students: [{
    "firstname": "Lýdie",
    "surname": "Mahdalová",
  ...
  id: 7, role: roles[1], fullName: 'Agáta Dittrichová', student: {
    "firstname": "Agáta",
    "surname": "Dittrichová",
  ...
  id: 8, role: roles[1], fullName: 'Ludmila Plašilová', student: {
    "firstname": "Ludmila",
    "surname": "Plašilová",
  ...
  id: 9, role: roles[1], fullName: 'Saskie Mertová', student: {
    "firstname": "Saskie",
    "surname": "Mertová",
...
export function UserProvider({children}) {
  ...
  const canShowDetail = (classroomId, subjectId) => {
    ...
    if (isTeacher()) {
      return user.classrooms.includes(classroomId) && user.subjects.includes(subjectId);
    }
