...
import {
  mdiClipboardListOutline, mdiLoading, mdiWeight, mdiStar, mdiText, mdiCalendar, mdiPlus, mdiReload, mdiClose
} from "@mdi/js";
  ...
  const handleGradeAdded = (grade) => {
    if (studentSubjectGradeListCall.state === "success") {
      setStudentSubjectGradeListCall({
        state: "success", data: [...studentSubjectGradeListCall.data, grade]
      });
    }
  }
